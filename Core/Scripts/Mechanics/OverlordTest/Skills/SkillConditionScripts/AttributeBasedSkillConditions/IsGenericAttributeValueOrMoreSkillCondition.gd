class_name IsGenericAttributeValueOrMoreSkillCondition
...
var ui_name: String = "Attribute is [val] or more"
...
func check_condition(_skill: Skill, target: Unit) -> bool:
	...
	if !attribute:
		push_error("Attribute not found in IsGenericAttriIsGenericAttributeValueOrMoreSkillConditionbuteValueSkillCondition")
		return false
